...
extension Client{
  ...
  static func Genres(listType: String, language: String?, genreId: Int, page: Int?, include_all_movies: Bool?, include_adult: Bool?, movieList: Bool?, completion: @escaping (ClientReturn) -> ()) -> (){
