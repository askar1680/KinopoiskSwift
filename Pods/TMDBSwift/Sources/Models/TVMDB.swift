...
extension TVMDB{
  ...
  public class func credits(tvShowID: Int!, completion: @escaping (_ clientResult: ClientReturn, _ data: TVCreditsMDB?) -> ()) -> (){
    ...
    public class func credits(tvShowID: Int!, language: String, completion: @escaping (_ clientResult: ClientReturn, _ data: TVCreditsMDB?) -> ()) -> (){
        Client.TV(String(tvShowID) + "/credits",  page: nil, language: language, timezone: nil){
            apiReturn in
            var data: TVCreditsMDB?
            if(apiReturn.error == nil){
                data =  TVCreditsMDB.init(results: apiReturn.json!)
  ...
  public class func images(tvShowID: Int!, language: String?, completion: @escaping (_ clientResult: ClientReturn, _ data: ImagesMDB?) -> ()) -> (){
    ...
    public class func images(tvShowID: Int!, completion: @escaping (_ clientResult: ClientReturn, _ data: ImagesMDB?) -> ()) -> (){
        Client.TV(String(tvShowID) + "/images",  page: nil, language: nil, timezone: nil){
            apiReturn in
            var data: ImagesMDB?
            if(apiReturn.error == nil){
                data = ImagesMDB.init(results: apiReturn.json!)
