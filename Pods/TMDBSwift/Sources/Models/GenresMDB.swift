...
open class GenresMDB: KeywordsMDB{
  ...
  ///Get the list of movies for a particular genre by id. By default, only movies with 10 or more votes are included.
    open class func genre_movies(genreId: Int, page: Int, include_adult_movies: Bool, language: String?, completion: @escaping (_ clientReturn: ClientReturn, _ data: [MovieMDB]?) -> ()) -> (){
    Client.Genres(listType: "movies", language: language, genreId: genreId, page: page, include_all_movies: true, include_adult: nil, movieList: true){
      apiReturn in
      if(apiReturn.error == nil){
