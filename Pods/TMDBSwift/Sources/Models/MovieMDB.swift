...
extension MovieMDB{
  ...
  public  class func credits(movieID: Int!, completion: @escaping (_ clientReturn: ClientReturn, _ credits: MovieCreditsMDB?) -> ()) -> (){
    ...
    public  class func credits(movieID: Int!, language: String, completion: @escaping (_ clientReturn: ClientReturn, _ credits: MovieCreditsMDB?) -> ()) -> (){
        Client.Movies(String(movieID) + "/credits",  page: nil, language: language){
            apiReturn in
            var credits: MovieCreditsMDB?
            if(apiReturn.error == nil){
                credits = MovieCreditsMDB.init(results: apiReturn.json!)
  ...
  public class func keywords(movieID: Int, completion: @escaping (_ clientReturn: ClientReturn, _ keywords: [KeywordsMDB]?) -> ()) -> (){
    ...
    public class func keywords(movieID: Int, language: String, completion: @escaping (_ clientReturn: ClientReturn, _ keywords: [KeywordsMDB]?) -> ()) -> (){
        Client.Movies(String(movieID) + "/keywords",  page: nil, language: language){
            apiReturn in
            var keywords: [KeywordsMDB]?
            if(apiReturn.error == nil){
                keywords = KeywordsMDB.initialize(json: apiReturn.json!["keywords"])
